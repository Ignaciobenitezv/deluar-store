...
export function DateRangeFilter() {
  ...
  return (
    <div className="relative z-20 grid w-full min-w-0 max-w-full grid-cols-2 gap-1 rounded-[16px] border border-slate-200 bg-slate-100 p-1 shadow-[0_6px_18px_rgba(15,23,42,0.03)] sm:flex sm:w-auto sm:flex-wrap sm:justify-end sm:rounded-full">
