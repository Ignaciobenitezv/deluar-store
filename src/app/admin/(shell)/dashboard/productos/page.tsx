...
const FIELD =
  "w-full rounded-[6px] border border-[#e2e8f0] bg-surface px-3 py-[8px] text-[13px] text-text-primary outline-none transition-colors hover:border-[#cbd5e1] focus:border-[#4f52c9] focus:ring-2 focus:ring-[#4f52c9]/15";
const FIELD_LABEL =
