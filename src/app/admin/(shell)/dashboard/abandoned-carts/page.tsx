...
const FIELD =
  "w-full rounded-[6px] border border-[#e2e8f0] bg-surface px-3 py-[7px] text-[13px] text-text-primary outline-none transition-colors hover:border-[#cbd5e1] focus:border-[#4f52c9] focus:ring-2 focus:ring-[#4f52c9]/15";
const FIELD_LABEL = "mb-1.5 block text-[10.5px] font-semibold uppercase tracking-[0.12em] text-text-secondary";
              ...
              <div className="flex flex-wrap items-end gap-3">
                ...
                <div className="flex shrink-0 items-center gap-2">
                  <a
                    ...
                    className="rounded-[6px] border border-[#e2e8f0] bg-surface px-3.5 py-[7px] text-[13px] font-medium text-text-primary transition-colors hover:border-[#cbd5e1] hover:text-text-primary"
                  >
                    Limpiar
                  </a>
                  <button
