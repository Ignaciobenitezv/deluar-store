...
function OperationRow({
  ...
  return (
    <div className="flex items-center justify-between gap-4 rounded-[8px] border border-border bg-surface-elevated px-3.5 py-3">
      ...
      <p className="shrink-0 text-[15px] font-semibold tracking-[-0.02em] text-text-primary">{value}</p>
    </div>
  );
}
          ...
          {totalShippingOrders > 0 ? (
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="rounded-[8px] border border-border bg-surface-elevated px-3.5 py-3">
                  <p className="text-[11px] font-semibold text-text-secondary">Costo total</p>
                  <p className="mt-1 text-[1rem] font-semibold tracking-[-0.02em] text-text-primary">
                    {formatDashboardPrice(totalShippingCost)}
                  </p>
                </div>
                <div className="rounded-[8px] border border-border bg-surface-elevated px-3.5 py-3">
                  <p className="text-[11px] font-semibold text-text-secondary">Costo promedio</p>
                  <p className="mt-1 text-[1rem] font-semibold tracking-[-0.02em] text-text-primary">
                    {formatDashboardPrice(averageShippingCost)}
                  </p>
                </div>
                <div className="rounded-[8px] border border-[var(--admin-success)]/25 bg-[var(--admin-success)]/10 px-3.5 py-3">
                  <p className="text-[11px] font-semibold text-[var(--admin-success)]">Envíos gratis</p>
                  <p className="mt-1 text-[1rem] font-semibold tracking-[-0.02em] text-[var(--admin-success)]">
                    {formatDashboardNumber(freeShippingOrders)}
                  </p>
                </div>
                <div className="rounded-[8px] border border-[var(--admin-info)]/25 bg-[var(--admin-info)]/10 px-3.5 py-3">
                  <p className="text-[11px] font-semibold text-[var(--admin-info)]">Envíos pagos</p>
                  <p className="mt-1 text-[1rem] font-semibold tracking-[-0.02em] text-[var(--admin-info)]">
