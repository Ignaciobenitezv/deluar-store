...
export default async function AdminDashboardSalesPage({
  ...
  return (
    <div className={cn(styles.root, "min-h-screen bg-[#f6f8fb]")}>
      <div className="w-full min-w-0 px-6 pb-12 pt-6">
        <nav aria-label="Ubicación" className="mb-5">
          <ol className="flex items-center gap-2 text-[13px]">
            <li>
              <Link href="/admin/dashboard" className={cn("text-[13px] text-[#64748b]", ledgerUi.link)}>
                Estadísticas
              </Link>
            </li>
            ...
            <li className="font-medium text-[#0f172a]" aria-current="page">
              Ventas
            </li>
          </ol>
        </nav>
        ...
        <div className="flex flex-wrap items-end justify-between gap-x-8 gap-y-4">
          <div className="min-w-0">
            <h1 className="text-[2.25rem] font-semibold leading-none tracking-[-0.04em] text-[#0f172a]">
              Ventas
            </h1>
            <p className="mt-3 text-[13.5px] tabular-nums text-[#64748b]">
              {rangeLabel} · {periodLabel}
            </p>
          </div>

          <div className="flex flex-wrap items-center gap-x-5 gap-y-3">
            <p className="hidden items-center gap-2 text-[12.5px] tabular-nums text-[#64748b] lg:flex">
        ...
        <LedgerHighlightProvider>
          ...
          <LedgerModule
            ...
            className="mt-5"
          >
            <p className="-mt-1 px-6 pb-4 text-[13px] tabular-nums text-[#64748b]">
              <span className="font-semibold text-[#0f172a]">
                {formatDashboardNumber(totalEntries)}
              </span>{" "}
              {totalEntries === 1 ? "orden" : "órdenes"}
              <span aria-hidden className="mx-2 text-[#cbd5e1]">
                ·
              </span>
              <span className="font-semibold text-[#0f172a]">
            ...
            {totalEntries > 0 ? (
              ...
              <div className="border-t border-[#e3e8ef] px-6 py-14 text-center">
