      ...
      <div className="flex-1 px-6 pb-12 pt-6 lg:px-8">
        <div className="w-full min-w-0">
            ...
            >
              <div className="flex flex-col gap-5 px-5 pb-5 sm:flex-row sm:items-start sm:gap-6">
                <div className="shrink-0 sm:w-[132px]">
                  <p className="text-[1.55rem] font-semibold leading-none tabular-nums tracking-[-0.035em] text-slate-900">
                    {paidOrders.count > 0 ? formatDashboardPrice(paidOrders.averageTicket) : "—"}
                  </p>
                  <p className="mt-1.5 text-[11.5px] text-slate-500">ticket promedio</p>
                  <p className="mt-3">
                    <DeltaChip delta={paidOrders.averageTicketDelta} />
                  </p>
                  {paidOrders.averageTicketDelta.direction !== "unmeasurable" ? (
                    <p className="mt-1 text-[11.5px] text-slate-400">vs. período anterior</p>
                  ) : null}
                </div>
          ...
          {untracked > 0 ? (
            <p
              className={cn(
                "mt-3 rounded-[8px] border border-[#e2e8f0] bg-white px-5 py-3.5 text-[12.5px] leading-[1.5] text-slate-500",
              )}
            >
